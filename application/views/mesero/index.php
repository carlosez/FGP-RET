...
for($i=0; $i<count($id_mesa);$i++)
{
	...
	<p>' .$variante[$i].'</p>
	<p class="ui-li-aside"><strong>Cantidad: '.$cantidad[$i].'</strong></p>
	</a>
	<a href="#" onclick="actualizar('.$idventa[$i].')" class="delete">Finalizar Pedido</a>
    <input type="hidden" name="idventa" id="idventa" value="'.$idventa[$i].'" />
	</li>';
}
echo $ordenes;
?>
